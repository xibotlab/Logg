...
for (let idx:number=0; idx<form.length; idx++) {
    document.getElementById(`btn${idx}`)?.addEventListener("click", () => {
        if (idx == form.length-1) {
            const email:string = (<HTMLInputElement>document.getElementById("emailinput"))?.value;
            const nickname:string = (<HTMLInputElement>document.getElementById("nicknameinput"))?.value;
            const pw:string = (<HTMLInputElement>document.getElementById("pwinput"))?.value;
            const pwagain:string = (<HTMLInputElement>document.getElementById("pwagaininput"))?.value;
...
document.getElementById("verifybtn")?.addEventListener("click", () => {
    ...
    const nickname:string = (<HTMLInputElement>document.getElementById("nicknameinput"))?.value;
    const pw:string = (<HTMLInputElement>document.getElementById("pwinput"))?.value;
    const verify:string = (<HTMLInputElement>document.getElementById("verifynum"))?.value;
